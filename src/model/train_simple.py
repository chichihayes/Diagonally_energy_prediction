...
def train_and_save(output_path: str = "src/model/trained/model_simple.joblib") -> None:
    train_df, test_df = load_and_split()
    X_train, y_train = build_simple_matrix(train_df)
    X_test, y_test = build_simple_matrix(test_df)
